...
def main(alpha,l1_ratio):
    ...
    mlflow.set_experiment("ML-Model-1") # set the experiment
    ...
    with mlflow.start_run():
        ...
        y_pred = model.predict(X_test) # generate the prediction
        rmse,mae,r2 = eval_function(y_test, y_pred) # calculate the metrics using eval function
